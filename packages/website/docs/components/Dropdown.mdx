...
It's also known as non-searchable [ComboBox][intellij-platform-combobox], in the reference implementation.
...
>
  ...
  <Dropdown label="Validated:" isInvalid defaultSelectedKey="Info">
    <Item key="Debug">Debug</Item>
    <Item key="Info">Info</Item>
    <Item key="Warning">Warning</Item>
    <Item key="Error">Error</Item>
