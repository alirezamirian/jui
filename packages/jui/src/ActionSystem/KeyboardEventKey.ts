/**
 * Copied from keyboard-event-key-type package, because the packaging was broken, plus, not all
 * types are separately exported.
 */
...
export type CustomValueKey = string;
